  ...
  return (
    <div className="subscription-container">
      ...
      <div className="plans-grid">
        {plans.map((plan) => (
          <div key={plan.id} className={`plan-card plan-card-${plan.color} ${plan.popular ? "plan-card-popular" : ""}`}>
            ...
            <div className="plan-footer">
              <button onClick={() => handleSelectPlan(plan)} className={`plan-button plan-button-${plan.color}`}>
                {plan.buttonText}
              </button>
            </div>
          </div>

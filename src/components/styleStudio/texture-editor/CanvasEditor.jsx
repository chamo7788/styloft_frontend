...
export const CanvasEditor = memo(
  ({
    ...
    // Handle mouse down for drawing or logo manipulation - optimized with useCallback
    ...
    // Update cursor based on current operation - optimized with useCallback
    ...
    // Handle mouse move for drawing or logo manipulation - optimized with useCallback
    const handleMouseMove = useCallback(
      (e) => {
        ...
        if (isDrawing) {
          // Handle drawing - optimized to reduce context creation
    ...
    // Handle mouse up for drawing or logo manipulation - optimized with useCallback
    ...
    }, [isDrawing, updateTextureFromCanvas, isDragging, isResizing, isRotating, saveCanvasState])
